    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BnaqueService
     */
    @WebEndpoint(name = "BnaqueServicePort")
    public BnaqueService getBnaqueServicePort() {
        return super.getPort(new QName("http://ws/", "BnaqueServicePort"), BnaqueService.class);
    }
     ...
     */
    @WebEndpoint(name = "BnaqueServicePort")
    public BnaqueService getBnaqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BnaqueServicePort"), BnaqueService.class, features);
    }
